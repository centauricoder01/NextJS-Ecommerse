...
const data = {
  isNew: true,
  imageURL: "https://m.media-amazon.com/images/I/71wYnCNtlYL._UY879_.jpg",
...
function Normalhoodies({ Prodata }) {
  return (
    <Grid
      p={50}
      w="100%"
...
export default Normalhoodies;

export async function getServerSideProps(context) {
  await connect();
  try {
    const pro = await productModel.find({ category: "normal" });
    return {
      props: {
